...
navigate(`/resumeDetail/${data?._id}`,{replace:true})
  ...
  return (
    ...
    <motion.div key={data?._id} {...scaleInOut(index)}>
      ...
      <div className='w-full h-[500px] 2xl:h-[740px] rounded-md
    ...
    onMouseLeave={()=>setIsHovered(false)}>
      ...
      <AnimatePresence>
        {isHovered && <motion.div
          ...
          className='px-3 py-2 rounded-md bg-gray-200 absolute -left-44 after:w-2 after:h-2 after:bg-gray-200 after:absolute after:-right-1
          after:top-[14px] after:rotate-45'
          >
